...
支持 **循环跑图 / 批量买车 / 熟练度加点 / 多模块串联 / 无限循环挂机**。
...
- `CCbrand.png`：消耗品车辆品牌
- `consumablecar.png`：用于点技能拿熟练度加点的消耗品车
- `newCC.png`：标记新车的消耗品车
...
## 鸣谢 (Acknowledgments)
本项目基于 [YOUSTHEONE](https://github.com/YOUSTHEONE/FH6Auto.git) 的原始概念与基础架构进行 Fork 并重构。
在原版基础上，重写了底层视觉识别引擎、引入了非阻塞状态机与全局 UI 路由寻路系统，并增加了热更新机制。
感谢原作者为本项目提供的灵感与前置探索！